    ...
    <div className="poster-sheet relative flex w-[210mm] flex-col overflow-hidden bg-white font-sans text-slate-800">
      ...
      <div className="relative z-10 rounded-b-[26px] bg-gradient-to-r from-brand-blue to-brand-blue-dark px-10 py-6 text-white shadow-lg shadow-blue-900/20">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-2xl font-extrabold tracking-tight">99Guard</p>
            <p className="mt-0.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/75">
              e-Patroli Digital
            </p>
          </div>
          <div className="rounded-full border border-white/40 bg-white/10 px-5 py-2 text-sm font-bold uppercase tracking-widest">
            Titik Patroli
          </div>
        </div>
      </div>

      <div className="relative z-10 flex flex-1 flex-col items-center gap-6 px-14 py-10">
        <img
          src="/logo.png"
          alt="99Guard"
        ...
        <div className="flex items-center gap-2 rounded-full bg-brand-blue px-6 py-2 text-white">
          <ScanLine className="size-4" />
          <span className="text-sm font-extrabold uppercase tracking-widest">Scan Disini</span>
        </div>

        <div className="flex items-center gap-4">
          <ChevronsRight className="size-20 text-brand-blue" />
          <div className="rounded-[28px] bg-white p-6 shadow-[0_16px_48px_-16px_rgba(15,98,254,0.45)] ring-1 ring-slate-200">
            {qrDataUrl && (
              <img src={qrDataUrl} alt={`QR ${qrCode}`} className="h-[320px] w-[320px]" />
            )}
          </div>
          <ChevronsLeft className="size-20 text-brand-blue" />
        </div>

        <div className="flex items-center gap-2 rounded-full bg-slate-100 px-5 py-2">
          <QrCode className="size-4 text-brand-blue" />
          <span className="font-mono text-sm font-bold tracking-wider text-slate-600">
            {qrCode}
          </span>
        </div>
        ...
        <div className="flex w-full max-w-md items-center justify-center gap-3 rounded-2xl bg-slate-50 px-6 py-4">
          ...
          <div className="min-w-0 text-center">
            <p className="text-[16px] font-bold uppercase tracking-widest text-slate-400">Site</p>
            <p className="truncate text-sm font-bold text-slate-800">{site}</p>
          </div>
        </div>
      ...
      <div className="relative z-10 flex items-center justify-between gap-4 bg-brand-blue-light/60 px-10 py-4 text-[11px] text-slate-500">
