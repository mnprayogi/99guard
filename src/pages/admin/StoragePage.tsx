        ...
        <>
          ...
          <div className="space-y-2.5">
            ...
            >
              ...
              Arsip & Hapus {stats.items.length} Foto
              <span className="hidden sm:inline"> dari Storage</span>
            </Button>
          ...
          {stats.items.length > 0 && (
            <div className="max-h-48 space-y-1 overflow-auto rounded-2xl border border-slate-200 bg-white p-3">
              ...
              {stats.items.map((it) => (
                <div
                  key={it.storage_path}
                  className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 text-xs text-slate-600"
                >
